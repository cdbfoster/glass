...
#ifndef GLASS_WINDOWLAYOUT_DUMMY_WINDOWLAYOUT
#define GLASS_WINDOWLAYOUT_DUMMY_WINDOWLAYOUT

#include "glass/core/WindowLayout.hpp"

namespace Glass
{
	class Dummy_WindowLayout : public WindowLayout
	{
	public:
		Dummy_WindowLayout(Vector const &Position, Vector const &Size);
		~Dummy_WindowLayout();
